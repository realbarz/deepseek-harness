...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/hardware-monitor/hardware-monitor': { kind: 'indirect', reason: 'The service interface delegates model rendering to dsh-tool-hardware-monitor.' },
  'packages/hardware-monitor/hardware-monitor-windows': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-hardware-monitor.' },
  ...
  'packages/client/ui-hardware-monitor': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
